import { TransformAnimationtNavigationProp } from '@src/Types/NavigationTypes';
...
type TransformAnimationProps = {
	navigation: TransformAnimationtNavigationProp;
};
export const TransformAnimation: FC<TransformAnimationProps> = () => {
	...
	const animationStyle = useAnimatedStyle(() => {
		...
		const bgColor = interpolateColor(boxToSircle.value, [0, 1], ['skyblue', 'teal']);
	...
	const textAnimation = useAnimatedStyle(() => {
		...
		const color = interpolateColor(textAni.value, [0, 0.5, 1], ['black', 'green', 'pink']);
